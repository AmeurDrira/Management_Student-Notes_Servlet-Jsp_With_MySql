...
<form class="form-horizontal" action="MatiereServlet" method="post">
			...
			<input type="hidden" name="id" value="${requestScope.obj.id }">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3"
							 name="coefficient" value="${requestScope.obj.coefficient }">
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">Credit</label>
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3"
							 name="credit" value="${requestScope.obj.credit }">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3"
							 name="volumec" value="${requestScope.obj.volumec }">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3"
							 name="volumetd" value="${requestScope.obj.volumetd }">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputPassword3"
							 name="volumetp" value="${requestScope.obj.volumetp }">
					</div>
				</div>
