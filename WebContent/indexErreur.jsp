...
<title>Gestion Notes | Log in</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="#"><b>Gestion </b>Notes</a>
		</div>
		<!-- /.login-logo -->
		<div class="login-box-body">
			<p class="login-box-msg">Authtification</p>
				<div class="callout callout-danger">
          <h4>Warning!</h4>

          <p>Verifier Vote login </br>Verifier Vote Mot de passe </br>Verifier Vote Role </br></p>
