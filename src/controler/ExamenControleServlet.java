...
/**
 * Servlet implementation class ExamenControleServlet
 */
@WebServlet("/ExamenControleServlet")
public class ExamenControleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = getServletContext().getRequestDispatcher("/EspaceEnsignantControleView.jsp");
